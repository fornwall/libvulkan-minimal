...
mkdir -p $VULKAN_SDK_MAC_VERSION/macOS/{lib/,include/vulkan/}
...
cp -Rf $VULKAN_SDK_MAC_VERSION-full/macOS/include/vulkan/* $VULKAN_SDK_MAC_VERSION/macOS/include/vulkan/
